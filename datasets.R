...
datasets_preprocess = function(codons_table,testing_flag){
  ...
  if (testing_flag){
    iterate_vals.testing = iterate_vals
    data_rows.testing = data_rows
    output.testing = output
    selected_input.testing = selected_input
    curr_details.testing = curr_details
    data_input.testing = data_input
    data_output.testing = data_output
    binary_data.testing = binary_data
    ...
    save(selected_input.testing,file = "selected_input.testing")
    save(curr_details.testing,file = "curr_details.testing")
    save(data_input.testing,file = "data_input.testing")
    save(data_output.testing,file = "data_output.testing")
    save(binary_data.testing,file = "binary_data.testing")
    save(input_iterate.testing,file = "input_iterate.testing")
  }else{
