...
predict_substitutions = function(begin_path,codons_table_training,codons_table_testing,iterate_vals,
                           unique_models,details,model_ids,num_first_models,output,data_input,data_output,
                           binary_data){
  ...
  cat("\n")
  pb <- txtProgressBar(min = 0, max = length(model_nums), style = 3, width = 50, char = "=")
